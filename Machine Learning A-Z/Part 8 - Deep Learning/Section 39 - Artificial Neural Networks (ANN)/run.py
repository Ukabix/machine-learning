...
# compiling the ANN with stochastic gradient effect and given loss function
# loss = 'binary_crossentropy' or 'categorical_crossentropy'
# metrics - criteria - always an array
classifier.compile(optimizer = 'adam', loss = 'binary_crossentropy', metrics =['accuracy'])

# Fitting ANN to the Training set
# classifier.fit(X_train, y_train)
# Choose update method and
...
# choose a threshold - format T/F bool
y_pred = (y_pred > 0.5)
